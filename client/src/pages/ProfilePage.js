  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-8">Personal data</h1>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    disabled={loading}
                  >
                      {loading ? 'Updating...' : 'Update your personal information'}
                  </button>
                </div>
              </form>
            </div>
        ...
        <div className="card mt-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white rounded-lg p-4 text-center">
              ...
              <p className="text-sm text-yellow-100">Complete the first mission</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-400 to-green-600 text-white rounded-lg p-4 text-center">
              ...
              <p className="text-sm text-green-100">Complete 5 tasks in one day</p>
            </div>
            ...
            <div className="bg-gray-300 text-gray-600 rounded-lg p-4 text-center opacity-60">
              ...
              <h3 className="font-semibold">Mission Master</h3>
              <p className="text-sm">Complete 50 missions</p>
            </div>
            ...
            <div className="bg-gray-300 text-gray-600 rounded-lg p-4 text-center opacity-60">
              ...
              <h3 className="font-semibold">The Flash</h3>
              <p className="text-sm">Complete 10 tasks ahead of schedule</p>
            </div>
          </div>
        </div>
      </div>
